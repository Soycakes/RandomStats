...
{
    // VanillaItemSlotWrapper from ExampleMod, with slight changes to Width/Height set - Soycake
    internal class VanillaItemSlotWrapper : UIElement
    {
        ...
        public VanillaItemSlotWrapper(int context = ItemSlot.Context.BankItem, float scale = 1f)
        {
            ...
            // Changed from Main.inventoryBack9.Width to TextureAssets instead, probably 1.4.4 thing
